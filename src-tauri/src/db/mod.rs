...
async fn seed_database(pool: &PgPool) -> Result<(), Box<dyn std::error::Error>> {
    ...
    sqlx::query(
        ...
        VALUES 
            (1, 'alex_kot', 'alex@example.com', '$argon2id$v=19$m=19456,t=2,p=1$dcDIVhmutBhzylxDzxLh9A$bCXJcw/9gQPyn8qsEcbwscCgbiBwWip58/xCM2IS+Zw', '/avatars/1.jpg', 'online', '2025-04-17 10:30:00+00', '{"input_device": "Microphone", "noise_suppression": true}'::jsonb, '{"camera": "HD", "fps": 30}'::jsonb, '2024-01-15 12:00:00+00', '2025-04-17 10:30:00+00'),
            (2, 'dj_max', 'max@example.com', '$argon2id$v=19$m=19456,t=2,p=1$VDLoFeT9CEM++wPPlxrdDw$ZBJMvIxmbLORR+c0u4Qdh2xhiKlWikQX3tJp29/bE8U', '/avatars/2.jpg', 'idle', '2025-04-17 09:15:00+00', '{"output_device": "Speakers", "volume": 0.8}'::jsonb, '{"camera": "4K", "fps": 60}'::jsonb, '2024-02-20 14:30:00+00', '2025-04-17 09:15:00+00'),
            (3, 'lena_voise', 'lena@example.com', '$argon2id$v=19$m=19456,t=2,p=1$17z1g6Z4jkK3mv1EYoFwcQ$6E6pz2oAaK3067c21gaDK2lmQo8oaogpWfdL+aEEAQU', '/avatars/3.jpg', 'dnd', '2025-04-17 11:00:00+00', '{"input_device": "Headset", "echo_cancellation": true}'::jsonb, '{"camera": "1080p", "fps": 30}'::jsonb, '2024-03-10 09:00:00+00', '2025-04-17 11:00:00+00'),
    ...
    sqlx::query(
        ...
        VALUES 
            (1, 'Gamers Club', '/icons/guild1.png', 1, 'Клан для игр и общения', '2024-01-20 12:00:00+00', '2025-04-10 15:00:00+00'),
            (2, 'Music Hub', '/icons/guild2.png', 2, 'Музыкальный сервер', '2024-02-25 18:30:00+00', '2025-04-12 20:00:00+00')
        "#
    )
    .execute(pool)
    .await?;
